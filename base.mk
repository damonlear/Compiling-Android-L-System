...
PRODUCT_PACKAGES += \
		iflytek \
	    libcom_iflytek_inputmethod_aitalk \
		libcom_iflytek_inputmethod_biubiu \
		libcom_iflytek_inputmethod_collect \
		libcom_iflytek_inputmethod_greeting \
		libcom_iflytek_inputmethod_magickeyboard \
		libcom_iflytek_inputmethod_mmp \
		libcom_iflytek_inputmethod_ocr \
		libcom_iflytek_inputmethod_search \
		libcom_iflytek_inputmethod_setting \
		libcom_iflytek_inputmethod_thirdbkservices \
		libcom_iflytek_inputmethod_translate \
		libcom_iflytek_inputmethod_voicegame \
		libdexopt \
		libencdec-jni-v1 \
		libiflytek-opus \
		liblwl \
		...
		libmsc-v9 \
		libnalsocket \
		libNativeCrashCollect \
		libsmartaiwrite-jni-v29 \
		libsmartaiwrite-jni-v31 \
		libspeex_fyj2 \
		libvadLib-v5 \
		libvipfont
# iflytek - end
...
# com.cepri.service - begin
PRODUCT_PACKAGES += \
    	com.cepri.service \
		libnative-lib
# com.cepri.service - end
...
PRODUCT_PACKAGES += \
		...
		libcepri_A1-X \
		libcepri_CL7202G \
		libcepri_COP-S-35-A-G2 \
		libcepri_EMOT500-M55 \
		libcepri_FOT-5.5-J-GT1716 \
		libcepri_FOT-5.5-J-HZWQ \
		libcepri_FOT-5.5-J-RSF1801 \
		libcepri_HE5001-II \
		libcepri_HE5001-IV-B \
		libcepri_HE5001-IV \
		libcepri_HL7202G \
		libcepri_HL7202G7 \
		libcepri_HL7202G9 \
		...
		libcepri_MST-VI \
		libcepri_MST-VII \
		libcepri_MST-VI_HT368D \
		libcepri_MST-VI_HT380D \
		libcepri_P1-70-M-L \
		libcepri_P2-55-M-L \
		libcepri_P3-55-M-L \
		libcepri_P4-80-M-L \
		...
		libcepri_X520 \
		libcepri_X7-M35 \
		libcepri_esky8735_tb_l1 \
		libcepri_k63v2_64_bsp \
		libcldbase \
		libcomtest \
		libdatabase_sqlcipher \
		libhmi_facade_android \
		libhmi_opengl_android \
		libhmi_package_android \
		libinfra \
		libkclan_jni \
		libmsc \
		libnavicm_misc_v1.0 \
...
# com.sgcc.pda.data - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.data
# com.sgcc.pda.data - end

# com.sgcc.pda.gis - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.gis \
		libcldbase.so \
		libhmi_facade_android.so \
		libhmi_opengl_android.so \
		libhmi_package_android.so \
		libkclan_jni.so \
		libmsc.so \
		libnavicm_misc_v1.0.so \
		libnavione.so \
		libsqlcipher.so
# com.sgcc.pda.gis - end

# com.sgcc.pda.guide - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.guide
# com.sgcc.pda.guide - end

# com.sgcc.pda.hw - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.hw \
    	libThintaPlatform \
    	libcepri_7202G \
...
# com.sgcc.pda.mdrh - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.mdrh \
		libsqlcipher
# com.sgcc.pda.mdrh - end

# com.sgcc.pda.mdrh.knows - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.mdrh.knows
# com.sgcc.pda.mdrh.knows - end

# com.sgcc.pda.mdrh.task.bc - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.mdrh.task.bc
# com.sgcc.pda.mdrh.task.bc - end

# com.sgcc.pda.mdrh.task.bt - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.mdrh.task.bt
# com.sgcc.pda.mdrh.task.bt - end

# com.sgcc.pda.mdrh.task.tifudian - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.mdrh.task.tifudian
# com.sgcc.pda.mdrh.task.tifudian - end

# com.sgcc.pda.web - begin
PRODUCT_PACKAGES += \
    	com.sgcc.pda.web
# com.sgcc.pda.web - end

# vpn-client_5.0-32bit - begin
#PRODUCT_PACKAGES += \
        vpn-client_5.0-32bit	\
        libnari			\
		libsafekey		\
		libSecurityUtil		\
		libskf			
# vpn-client_5.0-32bit - end
...
PRODUCT_COPY_FILES += \
#	packages/apps/pemt/DEVBaseServer/DEVBaseServer.apk:data/app/DEVBaseServer.apk \
#        packages/apps/pemt/sgcc/sgcc.apk:data/app/sgcc.apk
